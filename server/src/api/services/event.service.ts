...
import { CreateEventRequest, IOngoingEvent, UpdateEventReq } from '../@types/event'
...
import ongoingBattleController from '../socket/controllers/ongoing-battle.controller'
