...
function HomeThumbnail() {
  return (
    <Section title="Welcome to ⚔️ 漢字ガミ" description="Let's explore this website and learn a lot of kanji">
      <div className="rounded-[1.25rem] border-2 border-clr-border-1-light p-3 dark:border-clr-border-1-dark">
        <Carousel className="w-carousel" effect="fade" autoplay>
          <Image
            ...
            alt="app-slide-show"
            className="h-[30rem] rounded-lg object-cover shadow-light-panel dark:shadow-dark-panel"
          />
