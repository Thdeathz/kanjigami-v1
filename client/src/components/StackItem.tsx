...
function getStackItemClassName(className?: string) {
  return classNames(
    'card-item pointer-events-auto z-10 cursor-pointer rounded-2xl bg-gradient-to-tl from-card-light-start from-0% to-card-light-end to-100% p-2 shadow-card hover:translate-y-[-4px] hover:scale-105 hover:opacity-100 dark:from-card-dark-start dark:to-card-dark-end dark:shadow-dark-panel',
    className
  )
}
