...
function Footer() {
  return (
    <div className="flex min-h-[2.5rem] w-full items-center justify-between border-t border-clr-border-1-light bg-rgb-gray-0.75 px-5 font-semibold dark:border-clr-border-1-dark dark:bg-rgb-gray-0-0.75 dark:text-white">
