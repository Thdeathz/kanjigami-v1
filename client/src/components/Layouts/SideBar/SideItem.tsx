...
const SideItem = ({ icon, title, href, className }: PropsType) => {
  ...
  return (
    <div
      className={`group flex w-full cursor-pointer items-center justify-start gap-2.5 rounded-s-full py-2 pl-4 pr-8 text-side-item-light-link  dark:text-side-item-dark-link ${
        isActive &&
